...
export const PageSkeleton = ({ children, loading, height = "100vh", isDarkMode = false }) => {
...
export const CardSkeleton = ({ height = 200, width = "100%", isDarkMode = false }) => (
  <Card 
    sx={{ 
      width, 
      height,
...
export const ListSkeleton = ({ count = 3, height = 80, isDarkMode = false }) => (
  <Box>
...
export const GridSkeleton = ({ columns = 2, rows = 3, itemHeight = 200, isDarkMode = false }) => (
  <Grid container spacing={2}>
...
export const ButtonSkeleton = ({ width = 120, height = 40, isDarkMode = false }) => (
  <Skeleton
    variant="rectangular"
    width={width}
    height={height}
